  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between text-[15px]">
        ...
        <button
          className="selected bg-darker rounded-full px-4 py-1.5"
          ...
          <div className="flex flex-col gap-2.5 w-[290px]">
            ...
            <section className="flex items-center justify-between">
              ...
              <FilterSelector
                ...
                type="number"
                onChange={(val, filter) =>
                  createQueryString("length", filter, val)
                }
              />
            </section>
            <section className="flex items-center justify-between">
              ...
              <FilterSelector
                ...
                type="number"
                onChange={(val, filter) =>
                  createQueryString("bpm", filter, val)
                }
              />
            </section>
            <section className="flex items-center justify-between">
          ...
          <div className="flex flex-col gap-2.5 w-[300px]">
            ...
            <section className="flex items-center justify-between">
              ...
              <FilterSelector
                ...
                step={1}
                type="number"
                onChange={(val, filter) => createQueryString("ar", filter, val)}
              />
            </section>
            <section className="flex items-center justify-between">
              <h4>Circle size</h4>
              <FilterSelector
                ...
                step={1}
                type="number"
                onChange={(val, filter) => createQueryString("cs", filter, val)}
              />
            </section>
            <section className="flex items-center justify-between">
              ...
              <FilterSelector
                ...
                step={1}
                type="number"
                onChange={(val, filter) => createQueryString("od", filter, val)}
              />
            </section>
            <section className="flex items-center justify-between">
              <h4>HP drain rate</h4>
              <FilterSelector
                ...
                step={1}
                type="number"
                onChange={(val, filter) => createQueryString("hp", filter, val)}
              />
            </section>
          </div>
          ...
          <div className="flex-col gap-2.5 w-[310px] hidden lgx:flex">
            ...
            <section className="flex items-center justify-between">
              ...
              <FilterSelector
                type="date"
                onChange={(val, filter) =>
                  createQueryString("created", filter, val)
                }
                disabled
              />
            </section>
            <section className="flex items-center justify-between">
              ...
              <FilterSelector
                type="date"
                onChange={(val, filter) =>
                  createQueryString("updated", filter, val)
                }
                disabled
              />
            </section>
            <section className="flex items-center justify-between">
              ...
              <FilterSelector
                type="date"
                onChange={(val, filter) =>
                  createQueryString("ranked", filter, val)
                }
                disabled
              />
            </section>
