'use client'
import FilterSelector from '@/app/from-osu/_components/switches/FilterSelector'
import Switch from '@/app/from-osu/_components/switches/Switch'
               ...
               <div className="flex flex-col gap-2.5 w-[290px]">
                  ...
                  <section className="flex items-center justify-between">
                     ...
                     <FilterSelector
                        ...
                        step={10}
                        type="number"
                        onChange={(val, filter) => createQueryString('length', filter, val)}
                     />
                  </section>
                  <section className="flex items-center justify-between">
                     <h4>BPM</h4>
