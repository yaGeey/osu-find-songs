         ...
         <div className="bg-dialog relative flex flex-col justify-center items-center bg-main-lighter rounded-2xl p-10 shadow-lg border-4 border-main-border">
            ...
            <div className="flex gap-4 mt-10 w-full">
               <Link href="/from-osu/select">
                  <Button className="text-black bg-gradient-to-l from-[#1DB954] to-[#FF66AA] font-medium" onMouseEnter={() => handleMouseEnter('/from-osu.png')} onMouseLeave={handleMouseLeave}>Beatmaps to Spotify</Button>
               </Link>
               <Link href="/from-spotify/select">
                  <Button className="text-black bg-gradient-to-r from-[#1DB954] to-[#FF66AA] font-medium" onMouseEnter={() => handleMouseEnter('/from-spotify.png')} onMouseLeave={handleMouseLeave}>Spotify playlist to beatmaps</Button>
               </Link>
            </div>
         </div>
      </div>
