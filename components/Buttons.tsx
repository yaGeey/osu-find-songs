...
export function YoutubeBtn({ onClick, ref, className, ...props }: BtnProps) {
   return (
      <button onClick={onClick} ref={ref} {...props}
         className={tw("button w-[102px] h-[31px] bg-[#FFD7D7] border-2 border-[#FFA3A3] box-border rounded-xl flex justify-center items-center", className)}>
...
export function OtherBtn({ onClick, ref, className, ...props }: BtnProps) {
   return (
      <button onClick={onClick} ref={ref} {...props}
         className={tw("button w-[84px] h-[23px] bg-[#FFCACACC] border-2 border-[#FF9A9A] box-border rounded-xl text-black text-sm font-medium flex justify-center items-center", className)}>
         Other
      </button>
   )
}
...
export function OsuBtn({ onClick, ref, className, ...props }: BtnProps) {
   return (
      <button onClick={onClick} ref={ref} {...props}
         className={tw("button text-black ring-5 cursor-pointer w-[102px] h-[31px] bg-[#FFD7D7] border-[#FFA3A3] text-md font-medium", className)}>
