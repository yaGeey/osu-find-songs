      ...
      <div className={tw("transition-all z-100 absolute top-14 left-0 shadow-2xl animate-in slide-in-from-left bg-main border-4  border-main-border min-w-65 w-1/4 flex flex-col gap-4 p-4 rounded-xl rounded-t-none rounded-l-none border-t-0 border-l-0", className)}>
         ...
         <section className="flex flex-col ">
            ...
            <section className="flex items-center gap-2">
               ...
               />
               <label htmlFor="performance-spotify" className="text-sm">Show links instead of <em>Spotify</em> embeds</label>
            </section>
            <section className="flex items-center gap-2">
               <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 accent-main-border"
               />
               <label htmlFor="performance-youtube" className="text-sm">Show links instead of <em>YouTube</em> embeds</label>
            </section>
         </section>
      </div>
   )
