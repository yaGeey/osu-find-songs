   ...
   return (
      ...
      >
         ...
         {type == 'date' ?
            ...
            :
            <input type="number" step={step} onChange={(e) => setValue(e.target.value)} defaultValue={0} className={tw("w-[55px] bg-transparent text-center outline-hidden text-black [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none", isDisabled && 'pointer-events-none',)} max={max} min={min} />
         }
      </div>
   )
}