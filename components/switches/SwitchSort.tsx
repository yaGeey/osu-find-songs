      ...
      {options.map((option, i) => (
        ...
        >
          ...
          <div className="text-xs ml-1 ">
            {sort === "desc" && selection === option && (
              <FontAwesomeIcon icon={faSortDown} className="mt-1" />
            )}
            {sort === "asc" && selection === option && (
              <FontAwesomeIcon icon={faSortUp} className="mt-1" />
            )}
            {selection !== option && (
              <FontAwesomeIcon icon={faSortDown} className="opacity-0" />
            )}
          </div>
        </button>
      ))}
